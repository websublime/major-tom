...
| T2 | report: total_cents per docs/plans/report.md section 1 | T1 | [x] done |
| T3 | report: summarize_by_day per docs/plans/report.md section 2 | T2 | [ ] ready |
| T4 | CLI output per docs/plans/report.md section 3 | T3 | [ ] blocked |
