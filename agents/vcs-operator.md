...
3. Commit only what the review passed. Look at every file you are about to stage: nothing unreviewed, no debris, no secrets (keys, tokens, .env files). A secret in history is an incident, not a diff.
